...
macro(myproject_setup_options)
    ...
    if(NOT PROJECT_IS_TOP_LEVEL OR myproject_PACKAGING_MAINTAINER_MODE)
        ...
        option(myproject_ENABLE_USER_LINKER "Enable user-selected linker" OFF) # TODO: Test when ON
...
macro(myproject_global_options)
    ...
    if(myproject_ENABLE_HARDENING AND myproject_ENABLE_GLOBAL_HARDENING)
        ...
        message(STATUS "Hardening is ${myproject_ENABLE_HARDENING}.")
        message(STATUS "UBSAN Minimal Runtime is ${ENABLE_UBSAN_MINIMAL_RUNTIME}.")
        message(STATUS "Sanitizer Undefined is ${myproject_ENABLE_SANITIZER_UNDEFINED}.")
...
macro(myproject_local_options)
    ...
    if(myproject_ENABLE_COVERAGE)
        ...
        target_compile_options(myproject_options INTERFACE -O0 )
        target_link_libraries(myproject_options INTERFACE)
        append_coverage_compiler_flags()
        # append_coverage_compiler_flags_to_target(myproject_options)
    endif()
